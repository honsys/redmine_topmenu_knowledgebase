...
The hope is to continue to provide this as a top_menu selection. It supports program management overviews of multiple
(but perhaps unrelated) projects for redmine 2.6.0 and later.

https://github.com/honsys/redmine_topmenu_knowledgebase

## Original README from v2.3.0:
